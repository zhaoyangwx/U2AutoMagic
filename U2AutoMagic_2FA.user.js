...
(function(){
    ...
    if (String(location).includes("https://u2.dmhy.org/userdetails.php?") & String(location).includes("dllist=1")){
        var refreshlist = function refreshlist() {
            'use strict';
            // Your code here...
            var tlist = document.evaluate("/html/body/table[2]/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[23]/td[2]/div/table/tbody/tr", document, null, XPathResult.ANY_TYPE)
        ...
        if (GM_getValue('return')==true){
            var timer_returntolist = setInterval(function(){
                            ...
                            if (presult){
                                ...
                                // 返回到详情页
                                document.evaluate("/html/body/table[2]/tbody/tr[1]/td/table[2]/tbody/tr/td/table/tbody/tr/td[1]/span/a[12]", document, null, XPathResult.ANY_TYPE).iterateNext().click();
                            }
                        }, 1000)
            return 0;
        }
